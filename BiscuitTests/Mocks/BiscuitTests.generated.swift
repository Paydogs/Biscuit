...
open class FluxDispatcherMock: FluxDispatcher, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_registerStore__store_store(let lhsStore), .m_registerStore__store_store(let rhsStore)):
            ...
            case (.m_dispatch__action_action(let lhsAction), .m_dispatch__action_action(let rhsAction)):
				var results: [Matcher.ParameterComparisonResult] = []
        ...
        func intValue() -> Int {
            switch self {
            case let .m_registerStore__store_store(p0): return p0.intValue
            case let .m_dispatch__action_action(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_registerStore__store_store: return ".registerStore(store:)"
            case .m_dispatch__action_action: return ".dispatch(action:)"
            }
        }
    }
...
open class FluxStoreMock: FluxStore, Mock {
    ...
    fileprivate enum MethodType {
        ...
        static func compareParameters(lhs: MethodType, rhs: MethodType, matcher: Matcher) -> Matcher.ComparisonResult {
            switch (lhs, rhs) {
            case (.m_handleAction__action_action(let lhsAction), .m_handleAction__action_action(let rhsAction)):
				var results: [Matcher.ParameterComparisonResult] = []
				results.append(Matcher.ParameterComparisonResult(Parameter.compare(lhs: lhsAction, rhs: rhsAction, with: matcher), lhsAction, rhsAction, "action"))
				return Matcher.ComparisonResult(results)
            }
        ...
        func intValue() -> Int {
            switch self {
            case let .m_handleAction__action_action(p0): return p0.intValue
            }
        }
        func assertionName() -> String {
            switch self {
            case .m_handleAction__action_action: return ".handleAction(action:)"
            }
        }
    }
